...
#' @export
simulateFullWaveform = function(input, output, coords, inList = FALSE, ground = FALSE, hdf = TRUE, waveID = character(0), pSigma = -1.0, pFWHM = 15.0, readPulse = character(0), fSigma = 5.5, wavefront = character(0), res = 0.15, LVIS = FALSE, topHat = FALSE, sideLobe = FALSE, lobeAng = 0.0, checkCover = FALSE, maxScanAng = 1000000.0, decimate = 1.0, pBuff = 0.2, maxBins = 1024L, countOnly = FALSE, pulseAfter = FALSE, pulseBefore = FALSE, noNorm = FALSE, noOctree = FALSE, octLevels = 0L, nOctPix = 40L, decon = FALSE, indDecon = FALSE, readWave = FALSE, listFiles = FALSE, keepOld = FALSE, useShadow = FALSE, polyGround = FALSE, nnGround = FALSE, seed = numeric(0)) {
