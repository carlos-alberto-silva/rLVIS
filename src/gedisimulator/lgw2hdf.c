...
lvisHDF *copyLVISdata(lvisLGWstruct *lgw)
{
  ...
  if(!(hdf=(lvisHDF *)calloc(1,sizeof(lvisHDF)))){
    Rprintf("error in HDF structure allocation.\n");
    error("1");
  }
