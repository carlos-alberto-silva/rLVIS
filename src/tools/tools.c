...
int *markInt(int length,int *jimlad,int newVal)
{
  if(length>0){
...
uint32_t *markUint32(int length,uint32_t *jimlad,uint32_t newVal)
{
  if(length>0){
...
float *markFloat(int length,float *jimlad,float newVal)
{
  if(length>0){
...
float *markFloatOld(int length,float *jimlad,float newVal)
{
  int i=0;
  float *temparr=NULL;
...
double *markDo(int length,double *jimlad,double newVal)
{
  if(length>0){
...
char *markChar(int length,char *jimlad,char newVal)
{
  if(length>0){
...
unsigned char *markUchar(int length,unsigned char *jimlad,unsigned char newVal)
{
  if(length>0){
